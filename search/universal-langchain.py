...
# # Settings
# MEMORY_TYPE = "embedding_file"  # embedding_file, embedding_sentence
# RESPONSE_STRUCTURE = "directed" # loose, directed
# OUTPUT_FILE = 'test-section-document.csv'

# EMBEDDINGS_FILE = "document_embeddings.csv" if MEMORY_TYPE == "embedding_file" else "sentence_embeddings.csv" if MEMORY_TYPE == "embedding_sentence" else "embedding_section"
# EMBEDDING_PROVIDER = "openai"
# EMBEDDING_MODEL = 'text-embedding-3-large'

# SIMILARITY_CUTOFF = 0.3 # generally tried .3 for documents, .5 for sentence
# MAX_RESPONSE_TOKENS = 500
# CHAT_PROVIDER = 'openai' # openai google anthropic cohere
# CHAT_MODEL = 'gpt-4o' #gpt-4o gpt-4o-mini gemini-1.5-pro gemini-1.5-flash claude-3-5-sonnet-latest claude-3-5-haiku-latest command-r-plus command-r

# # next iteration of testing should take from answer to pull the tokens of the response/input alongside cost estimations and time to generate
...
#         # return self.client.embed_query(text, model=self.model_name)
# class ChatModel:
#     def __init__(self, provider, model_name):
#         self.provider = provider
#         self.model_name = model_name
...
#         query = a if a != None else input("Your question: ")
...
#         answer = self.generate_final_answer(query, relevant_sections)
#         print("Answer:", answer)
